...
;* Project           : Basic_C
;*
;* Program name      : linkList_TailInsertion.c
;*
...
;*
;* Purpose           : A template showing Link List - Tail Insertion. Ansi-style
;*
;* Revision History  :
;*
;* Date        Author      Ref    Revision (Date in DDMMYYYY format)
;* 02012019    lst97       1      First release
;*
;* Known Issue       :
;*
...
;* Reference:
;*
;* 1. https://www.bilibili.com/video/av27744141/?p=46
;|**********************************************************************;
*/
#include <stdio.h>
#include <string.h>
...
void createContact(struct Contact **contactHead){
	...
	static struct Contact *contactTail;
	...
	if(*contactHead != NULL){
		contactTail->nextContactPtr = contactPointer;
