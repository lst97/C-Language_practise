...
;* Project           : Basic_C_GUI
;*
;* Program name      : basicMouseEventDoubleClick.c
;*
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
	...
	// CODE
	switch(message){
	// Remember to add CS_DBLCLKS in the wndClass.style
	case WM_LBUTTONDBLCLK:
		MessageBox(hWnd, TEXT("Double Clicked"), TEXT("MESSAGE"), MB_OK | MB_ICONINFORMATION);
		return 0;
